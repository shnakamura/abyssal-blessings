...
using AbyssalBlessings.Content.Items.Pets;
using CalamityMod;
...
namespace AbyssalBlessings.Content.NPCs.Nahlyn;

[AutoloadHead]
public class TownNahlyn : ModNPC
{
    ...
    public override void AddShops() {
        ...
        new NPCShop(Type)
            .AddWithCustomValue<ZephyrsHeartItem>(Item.buyPrice(1))
            .AddWithCustomValue<SirensPearlItem>(Item.buyPrice(gold: 10))
